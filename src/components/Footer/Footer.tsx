    ...
    <footer className={styles.footer} aria-label="Site Footer">
      <div className={styles.container}>
        ...
        <section className={styles.section} aria-labelledby="footer-brand-name">
          <h2 id="footer-brand-name" className={styles.logo}>
            Resin Kalaakaari
          </h2>
        ...
        >
          <h3 id="footer-quick-links" className={styles.heading}>
            Quick Links
          </h3>
          <ul role="list">
            <li>
        ...
        >
          <h3 id="footer-company-links" className={styles.heading}>
            Company
          </h3>
          <ul role="list">
            <li>
        ...
        >
          <h3 id="footer-social-links" className={styles.heading}>
            Connect With Us
          </h3>
      ...
      <div className={styles.bottom}>
        <p>© {currentYear} Resin Kalaakaari. All rights reserved.</p>
      </div>
    </footer>
  );
}
