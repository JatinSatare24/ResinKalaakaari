  ...
  return (
    <main className={styles.aboutContainer} aria-labelledby="about-main-title">
      ...
      <header className={styles.heroSection}>
        <h1 id="about-main-title" className={styles.mainTitle}>
          Our Story
        </h1>
      ...
      <section
        ...
        aria-labelledby="artist-intro-heading"
      >
        {/* --- PROFILE IMAGE SIDE --- */}
        <div
          className={styles.imageWrapper}
          role="img"
          aria-label="Portrait of Sanika"
        >
          <Image
        ...
        <div className={styles.textWrapper}>
          ...
          <article className={styles.storyText}>
            <p>
              ...
              meaningful journey of creating{" "}
              <strong className={styles.highlight}>
                personalized resin keepsakes
              </strong>
            ...
            <p>
              From preserving wedding{" "}
              <strong className={styles.highlight}>varmala flowers</strong> to
              creating custom nameplates and personalized gifts, my goal is
              simple—to turn your emotions into timeless creations.
            </p>
